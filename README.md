...
Developed a serverless application that automatically processes and translates
text files using AWS S3 and AWS Lambda. The system triggers a Lambda function
whenever a file is uploaded, processes the content, and stores translated
outputs.
